...
var yadcf = (function($) {
    ...
    for (i = 0; i < options_arg.length; i++) {
      ...
      if (options_arg[i].filter_type === 'custom_func') {
        if (options_arg[i].custom_func === undefined) {
          alert('You are trying to use filter_type: "custom_func" for column ' + options_arg[i].column_number +
              ' but there is no such custom_func attribute provided (custom_func: \"function reference goes here...\")')
          return
        }
        if (options_arg[i].data === undefined) {
          alert('You are trying to use filter_type: "custom_func" for column ' + options_arg[i].column_number +
              ' but there is no such data attribute provided (data: \"array of options goes here...\")')
          return
        }
      }
  ...
  function addRangeNumberFilter(
      filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
    ...
    $(filter_selector_string).
        append('<div onclick="yadcf.stopPropagation(event);" id="' + filter_wrapper_id + '" class="yadcf-filter-wrapper"></div>')
    filter_selector_string = filter_selector_string + ' div.yadcf-filter-wrapper'
    filter_selector_string_tmp = filter_selector_string

    $(filter_selector_string).
        append('<div id="yadcf-filter-wrapper-inner-' + table_selector_jq_friendly + '-' + column_number +
            '" class="yadcf-filter-wrapper-inner"></div>')
    filter_selector_string = filter_selector_string + ' div.yadcf-filter-wrapper-inner'

    $(filter_selector_string).
        append('<input placeholder="' + filter_default_label[0] + '" id="' + fromId +
            '" class="yadcf-filter-range-number yadcf-filter-range" onkeyup="yadcf.rangeNumberKeyUP(\'' + table_selector_jq_friendly +
            '\',event);">' +
            '</input>')
    $(filter_selector_string).append('<span class="yadcf-filter-range-number-seperator" >' +
        '</span>')
    $(filter_selector_string).
        append('<input placeholder="' + filter_default_label[1] + '" id="' + toId +
            '" class="yadcf-filter-range-number yadcf-filter-range" onkeyup="yadcf.rangeNumberKeyUP(\'' + table_selector_jq_friendly +
            '\',event);">' +
            '</input>')
    ...
    if (filter_reset_button_text !== false) {
      $(filter_selector_string_tmp).append('<input value="' + filter_reset_button_text + '" type="button" ' +
          'onclick="yadcf.stopPropagation(event);yadcf.rangeClear(\'' + table_selector_jq_friendly +
    ...
    if (oTable.fnSettings().oFeatures.bStateSave === true && oTable.fnSettings().oLoadedState) {
      if (oTable.fnSettings().oLoadedState.yadcfState && oTable.fnSettings().oLoadedState.yadcfState[table_selector_jq_friendly] &&
  ...
  function dateSelect(date, event) {
    ...
    if (oTable.fnSettings().oFeatures.bStateSave === true) {
      if (oTable.fnSettings().oLoadedState.yadcfState !== undefined && oTable.fnSettings().oLoadedState.yadcfState[table_selector_jq_friendly] !==
          undefined) {
        oTable.fnSettings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number] =
            {
              'from': from,
  ...
  function addRangeDateFilter(
      filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
    ...
    $(filter_selector_string).
        append('<input placeholder="' + filter_default_label[0] + '" id="' + fromId +
            '" class="yadcf-filter-range-date yadcf-filter-range" onkeyup="yadcf.rangeDateKeyUP(\'' + table_selector_jq_friendly + '\',\'' +
            date_format + '\',event);">' +
            '</input>')
  ...
  function addDateFilter(
    ...
    $(filter_selector_string).
        append('<input placeholder="' + filter_default_label + '" id="' + dateId + '" class="yadcf-filter-date" onkeyup="yadcf.dateKeyUP(\'' +
    ...
    if (filter_reset_button_text !== false) {
      $(filter_selector_string_tmp).append('<input value="' + filter_reset_button_text + '" type="button" id="' + dateId + '-reset"' +
          'onclick="yadcf.stopPropagation(event);yadcf.dateSelectSingle(\'' + table_selector_jq_friendly +
          '\',event.target, \'clear\'); return false;" class="yadcf-filter-reset-button">')
    }
    ...
    if (oTable.fnSettings().aoPreSearchCols[column_number].sSearch !== '') {
      $('#yadcf-filter-' + table_selector_jq_friendly + '-' + column_number).
          val(oTable.fnSettings().aoPreSearchCols[column_number].sSearch).
          addClass('inuse')
    }
  ...
  function addRangeNumberSliderFilter(
      filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, min_val, max_val, ignore_char) {
    ...
    $(filter_selector_string).
        append('<div id="yadcf-filter-wrapper-inner-' + table_selector_jq_friendly + '-' + column_number +
            '" class="yadcf-number-slider-filter-wrapper-inner"></div>')
    ...
    if (isFinite(min_val) && isFinite(max_val) && isFinite(min_state_val) && isFinite(max_state_val)) {
      ...
      if (filter_reset_button_text !== false) {
        $(filter_selector_string_tmp).append('<input value="' + filter_reset_button_text + '" type="button" ' +
            'onclick="yadcf.stopPropagation(event);yadcf.rangeNumberSliderClear(\'' + table_selector_jq_friendly +
            '\',event); return false;" class="yadcf-filter-reset-button range-number-slider-reset-button">')
      }
    }
    ...
    if (oTable.fnSettings().oFeatures.bStateSave === true && oTable.fnSettings().oLoadedState) {
      if (oTable.fnSettings().oLoadedState.yadcfState && oTable.fnSettings().oLoadedState.yadcfState[table_selector_jq_friendly] &&
        ...
        if ((isFinite(min_val) && isFinite(max_val)) &&
            (min_val !== oTable.fnSettings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].from || max_val !==
                oTable.fnSettings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].to)) {
    ...
    for (columnObjKey in args) {
      if (args.hasOwnProperty(columnObjKey)) {
        ...
        if (filter_container_id === undefined) {
          ...
          for (col_num_visible_iter = 0; col_num_visible_iter < oTable.fnSettings().aoColumns.length && col_num_visible_iter <
          column_number; col_num_visible_iter++) {
        ...
        if (columnObj.filter_type === 'select' || columnObj.filter_type === 'auto_complete' || columnObj.filter_type === 'multi_select' ||
            columnObj.filter_type === 'custom_func') {
          if (sort_as === 'alpha') {
            if (sort_order === 'asc') {
              options.sort()
        ...
        if ($filter_selector.length === 1) {
          ...
          if (columnObj.filter_type === 'select' || columnObj.filter_type === 'custom_func') {
            ...
            //add a wrapper to hold both filter and reset button
            $(filter_selector_string).
                append('<div id="yadcf-filter-wrapper-' + table_selector_jq_friendly + '-' + column_number +
                    '" class="yadcf-filter-wrapper"></div>')
            filter_selector_string = filter_selector_string + ' div.yadcf-filter-wrapper'

            if (columnObj.filter_type === 'select') {
              $(filter_selector_string).
                  append('<select id="yadcf-filter-' + table_selector_jq_friendly + '-' + column_number + '" class="yadcf-filter" ' +
                      'onchange="yadcf.doFilter(this, \'' + table_selector_jq_friendly + '\', ' + column_number + ', \'' + filter_match_mode +
                      '\')" onclick=\'yadcf.stopPropagation(event);\'>' + options + '</select>')
              if (filter_reset_button_text !== false) {
                $(filter_selector_string).find('.yadcf-filter').after('<input value="' + filter_reset_button_text + '" type="button" ' +
                    'onclick="yadcf.stopPropagation(event);yadcf.doFilter(\'clear\', \'' + table_selector_jq_friendly + '\', ' + column_number +
                    '); return false;" class="yadcf-filter-reset-button">')
              }
            } else {
              $(filter_selector_string).
                  append('<select id="yadcf-filter-' + table_selector_jq_friendly + '-' + column_number + '" class="yadcf-filter" ' +
                      'onchange="yadcf.doFilterCustomDateFunc(this, \'' + table_selector_jq_friendly + '\', ' + column_number +
                      ')" onclick=\'yadcf.stopPropagation(event);\'>' + options + '</select>')
              if (filter_reset_button_text !== false) {
                $(filter_selector_string).find('.yadcf-filter').after('<input value="' + filter_reset_button_text + '" type="button" ' +
                    'onclick="yadcf.stopPropagation(event);yadcf.doFilterCustomDateFunc(\'clear\', \'' + table_selector_jq_friendly + '\', ' +
                    column_number + '); return false;" class="yadcf-filter-reset-button">')
              }
              if (oTable.fnSettings().oFeatures.bServerSide !== true) {
                addCustomFunctionFilterCapability(table_selector_jq_friendly, 'yadcf-filter-' + table_selector_jq_friendly + '-' + column_number,
                    column_number)
              }
            }
            ...
            $(filter_selector_string).
                append('<select multiple data-placeholder="' + filter_default_label + '" id="yadcf-filter-' + table_selector_jq_friendly + '-' +
                    column_number + '" class="yadcf-filter" ' +
                    'onchange="yadcf.doFilterMultiSelect(this, \'' + table_selector_jq_friendly + '\', ' + column_number + ', \'' + filter_match_mode +
                    '\')" onclick=\'yadcf.stopPropagation(event);\'>' + options + '</select>')
            ...
            $(filter_selector_string).
                append('<input id="yadcf-filter-' + table_selector_jq_friendly + '-' + column_number +
                    ...
                    + '\' placeholder=\'' + filter_default_label + '\'' + ' filter_match_mode=\'' + filter_match_mode + '\'' +
                    ' onkeyup="yadcf.autocompleteKeyUP(\'' + table_selector_jq_friendly + '\',event);"></input>')
            $(document).data('yadcf-filter-' + table_selector_jq_friendly + '-' + column_number, options)

            if (filter_reset_button_text !== false) {
              $(filter_selector_string).find('.yadcf-filter').after('<input value="' + filter_reset_button_text + '" type="button" ' +
                  'onclick="yadcf.stopPropagation(event);yadcf.doFilterAutocomplete(\'clear\', \'' + table_selector_jq_friendly + '\', ' +
                  column_number + '); return false;" class="yadcf-filter-reset-button">')
            }
            ...
            $(filter_selector_string).
                append('<input type="text" id="yadcf-filter-' + table_selector_jq_friendly + '-' + column_number +
                    '" class="yadcf-filter" onclick=\'yadcf.stopPropagation(event);'
                    + '\' placeholder=\'' + filter_default_label + '\'' + ' filter_match_mode=\'' + filter_match_mode + '\'' +
                    ' onkeyup="yadcf.textKeyUP(\'' + table_selector_jq_friendly + '\',event);"></input>')

            if (filter_reset_button_text !== false) {
              $(filter_selector_string).
                  find('.yadcf-filter').
                  after('<input value="' + filter_reset_button_text + '" type="button" ' + ' id="yadcf-filter-' + table_selector_jq_friendly +
                      '-' + column_number + '-reset"' +
                      'onclick="yadcf.stopPropagation(event);yadcf.textKeyUP(\'' + table_selector_jq_friendly +
                      '\', event, \'clear\'); return false;" class="yadcf-filter-reset-button">')
            }
            ...
            addDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label,
                date_format)
            ...
            addRangeDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label,
                date_format)
        ...
        if ($(document).data('#yadcf-filter-' + table_selector_jq_friendly + '-' + column_number + '_val') !== undefined &&
          ...
          $(filter_selector_string).
              find('.yadcf-filter').
              val($(document).data('#yadcf-filter-' + table_selector_jq_friendly + '-' + column_number + '_val'))
        }
  ...
  function rangeDateKeyUP(table_selector_jq_friendly, date_format, event) {
    ...
    column_number = parseInt(
        $(event.target).attr('id').replace('-from-date-', '').replace('-to-date-', '').replace('yadcf-filter-' + table_selector_jq_friendly, ''), 10)
    options = getOptions(oTable.selector)[column_number]
  ...
  function rangeNumberKeyUP(table_selector_jq_friendly, event) {
    ...
    column_number = parseInt(
        $(event.target).attr('id').replace('-from-', '').replace('-to-', '').replace('yadcf-filter-' + table_selector_jq_friendly, ''), 10)
    options = getOptions(oTable.selector)[column_number]
  ...
  function textKeyUP(table_selector_jq_friendly, event, clear) {
    ...
    var column_number = parseInt($(event.target).attr('id').replace('yadcf-filter-' + table_selector_jq_friendly + '-', '').replace('-reset', ''),
        10),
        oTable = oTables[table_selector_jq_friendly],
        options = getOptions(oTable.selector)[column_number],
