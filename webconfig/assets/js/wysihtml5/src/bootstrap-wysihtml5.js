!function($, wysi) {
  ...
  var tpl = {
    ...
    'lists': function(locale, options) {
      ...
      return '<li>' +
          '<div class=\'btn-group\'>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-command=\'insertUnorderedList\' title=\'' + locale.lists.unordered +
          '\' tabindex=\'-1\'><i class=\'fa-list-ul\'></i></a>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-command=\'insertOrderedList\' title=\'' + locale.lists.ordered +
          '\' tabindex=\'-1\'><i class=\'fa-list-ol\'></i></a>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-command=\'Outdent\' title=\'' + locale.lists.outdent +
          '\' tabindex=\'-1\'><i class=\'fa-outdent\'></i></a>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-command=\'Indent\' title=\'' + locale.lists.indent +
          '\' tabindex=\'-1\'><i class=\'fa-indent\'></i></a>' +
          '</div>' +
          '</li>'
    },
    ...
    'link': function(locale, options) {
      ...
      return '<li>' +
          ...
          '<label class=\'checkbox\'> <input type=\'checkbox\' class=\'bootstrap-wysihtml5-insert-link-target iswitch\' checked>' + locale.link.target +
          '</label>' +
          '</div>' +
          ...
          '</div>' +
          '</div>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-command=\'createLink\' title=\'' + locale.link.insert +
          '\' tabindex=\'-1\'><i class=\'fa-external-link\'></i></a>' +
          '</li>'
    },
    ...
    'image': function(locale, options) {
      ...
      return '<li>' +
          ...
          '</div>' +
          '</div>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-command=\'insertImage\' title=\'' + locale.image.insert +
          '\' tabindex=\'-1\'><i class=\'fa-camera-retro\'></i></a>' +
          '</li>'
    },
    ...
    'html': function(locale, options) {
      ...
      return '<li class=\'html-code-icon\'>' +
          '<div class=\'btn-group\'>' +
          '<a class=\'btn' + size + '\' data-wysihtml5-action=\'change_view\' title=\'' + locale.html.edit +
          '\' tabindex=\'-1\'><i class=\'fa-code\'></i></a>' +
          '</div>' +
          '</li>'
    },
